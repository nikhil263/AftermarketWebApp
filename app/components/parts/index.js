...
class Parts extends Component {
  render() {
    const { dispatch, history, app, params, images, parts, results } = this.props;
    const childProps = {
      params,
      app,
      images,
    ...
    return (
      <div className="grid-block vertical align-center">
        <Step history={history} dispatch={dispatch} app={app} onClick={backClick} />
        <div className="grid-content">
          <div className="grid-container main-content">{childrenWithProps}</div>
        </div>
      </div>
    );
  }
