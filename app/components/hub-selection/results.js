            ...
            <div className="unitized">
                ...
                <div className="result">
                    <div className="details">
                        <p>Volvo/Mack unitized hub assemblies can be identified by their 8-sided, thread-on hubcaps and parallel, closely-spaced bearings.</p>
                        ...
                        <p className="hub-name">Volvo/Mack unitized hub assemblies are not serviceable, please contact your local Volvo/Mack dealer for service enquiries. </p>
