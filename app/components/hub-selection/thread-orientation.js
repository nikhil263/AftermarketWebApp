...
const FILTERIDX=9
const NEXT_FILTER_PATH = '/hub-selection/hamnt'
	...
	render() {
		...
		return (
			<div className="grid-container main-content">
				<h2>Thread Orientation</h2>
				<div className="grid-block">
					{app.filterResults.map((result, index) => {
						var boundClick = setFilter.bind(this, FILTERIDX, {strdo: result.Id}, app);
...
export default connect()(ThreadOrientation)
