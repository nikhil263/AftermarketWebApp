...
const FILTERIDX=18
const NEXT_FILTER_PATH = '/hub-selection/hub-cap-bolt-circle-diameter-inches'
	...
	render() {
		...
		return (
			<div className="grid-container main-content">
				<h2>ABS Offset Inches</h2>
				<div className="grid-block">
					{app.filterResults.map((result, index) => {
						var boundClick = setFilter.bind(this, FILTERIDX, {abcoi: result.Inch}, app.NEXT_FILTER_PATH = NEXT_FILTER_PATH);
...
export default connect()(ABSOffsetInches)
